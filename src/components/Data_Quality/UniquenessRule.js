...
function UniquenessRule({ show, onHide }) {
  return (
    <Modal show={show} onHide={onHide} centered size="lg">
      <Modal.Header closeButton>
        <Modal.Title> "Uniqueness" Rule</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <p>
          {" "}
          Uniqueness DQ rule scans a columns to count the cells with missing
